...
## Refactor Challenge - What did we have to change?
 - move state to closest parent
 - move the callbacks that set the state
 - pass down the new state and the new callbacks as props
 - had to move helper functions
...
- Introducing Redux, the store and reducer
- Designing our redux state
- Reading form the new store state
