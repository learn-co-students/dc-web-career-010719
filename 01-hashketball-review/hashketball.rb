...
def num_points_scored(player_name)
  # returns integer of points scored by named player
  get_player(player_name)[:points]
end

def shoe_size(player_name)
  # returns integer of shoe size of named player
